...
public class DefaultRegisterView extends AbstractRegisterView {
    ...
    protected void onAttributeInitialize(@NonNull AttributeSet attrs) {
        TypedArray attributes = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.DefaultRegisterView, 0, 0);
        try {
            backgroundEditFirstName = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegEdits);
            backgroundEditLastName = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegEdits);
            backgroundEditEmail = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegEdits);
            backgroundEditPassword = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegEdits);
            backgroundEditPasswordAgain = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegEdits);
            backgroundButton = attributes.getDrawable(R.styleable.DefaultRegisterView_backgroundRegButton);

            colorTextEdits = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegEdits);
            colorHintEdits = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegHintEdits);
            colorTextLabels = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegLabels);
            colorTextButtons = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegTextButton);

            colorTextLoading = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegLoadingMessage);
            colorBackgroundLoading = attributes.getColorStateList(R.styleable.DefaultRegisterView_colorRegLoadingBackground);

            dimenLabelsText = attributes.getDimensionPixelSize(R.styleable.DefaultRegisterView_dimenRegLabels, R.dimen.text_18);
            dimenEditsText = attributes.getDimensionPixelSize(R.styleable.DefaultRegisterView_dimenRegEdits, R.dimen.text_18);
